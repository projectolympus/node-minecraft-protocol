  ...
  play: {
    toClient: {
      ...
      named_entity_spawn:       {id: 0x0c, fields: [
        ...
        { name: "x", type: "fixedPointInt" },
        { name: "y", type: "fixedPointInt" },
        { name: "z", type: "fixedPointInt" },
        { name: "yaw", type: "byte" },
      ...
      rel_entity_move: {id: 0x15, fields: [
        { name: "entityId", type: "int" },
        { name: "dX", type: "fixedPointByte" },
        { name: "dY", type: "fixedPointByte" },
        { name: "dZ", type: "fixedPointByte" }
      ]},
...
function readFixedPointInt(buffer, offset) {
  var t = readInt(buffer, offset);
...
function readFixedPointByte(buffer, offset) {
  var t = readByte(buffer, offset);
...
function writeFixedPointByte(value, buffer, offset) {
  return writeByte(value * 32, buffer, offset);
}
...
function writeFixedPointInt(value, buffer, offset) {
  return writeInt(value * 32, buffer, offset);
}
